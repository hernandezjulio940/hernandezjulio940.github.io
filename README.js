...
DFZWassistant by Julio
Version 6.7 and counting
...
var zdui = {
	...
	_addBoxHeader: function(){
		var strHtml = "";
		strHtml +=	
			'<h2><a href="'+zdHomePageUrl+'">Julio</a> '+zdui.getLabel("title")+' ';
		if(zdui.isLite){
			strHtml += ' <em>Lite</em> ';
		}
		strHtml +=
	...
	_addBoxIntro: function(){
		...
		strHtml +=
			...
			'<p style="text-align: center;"><a href="javascript:Magic8Ball();"><img alt="" src=" https://phx.titaniumtv.xyz/tenor.gif width="450" height="450" title="click for answer" /></a><br/>'+
...
function zdHeartAttack(){
	...
	var questionParameters = {
		...
		bodyText: "It seems that you might have been getting some stuff you shouldn't... Is this true? Have you been naughty? Julio is giving you two options, your choice:",
